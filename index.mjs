// State Bank of Vietnam exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/sbv';
...
/** Latest rate for one pair, e.g. getRate('USD', 'VND', { apiKey }). */
